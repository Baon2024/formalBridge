...
function TicketCard({ticket}) {
    ...
    console.log("formalTicketCollegebackgroundImage through object properyty:", ticket.formalTicketCollegeBackgroundImage);
    ...
    return (
      <div className={styles.cardContainer} onClick={handleClick} key={formalTicketID}>
        <img src={formalTicketCollegeBackgroundImageURL ? `http://localhost:1338${formalTicketCollegeBackgroundImageURL}` : 'public/queens.jpeg'} alt="Background" className={styles.cardImage} />
